...
use GibsonOS\Module\Hc\Config\Event\Describer\Parameter\AutoCompleteParameter;
...
use GibsonOS\Module\Hc\Config\Event\Describer\Parameter\OptionParameter;
...
class Io implements DescriberInterface
{
    ...
    public function getTriggers(): array
    {
        $portAttributeParameters = [
            ...
            IoService::ATTRIBUTE_PORT_KEY_DIRECTION => $this->directionParameter,
            IoService::ATTRIBUTE_PORT_KEY_VALUE => new BoolParameter('An'),
            IoService::ATTRIBUTE_PORT_KEY_DELAY => new IntParameter('Verzögerung'),
            IoService::ATTRIBUTE_PORT_KEY_PULL_UP => new IntParameter('PullUo'),
            IoService::ATTRIBUTE_PORT_KEY_PWM => new IntParameter('PWM'),
            IoService::ATTRIBUTE_PORT_KEY_FADE_IN => new IntParameter('Einblenden'),
            IoService::ATTRIBUTE_PORT_KEY_BLINK => new IntParameter('Blinken')
        ];
        $directConnectAttributeParameters = [
            'slave' => $this->slaveParameter,
            IoService::ATTRIBUTE_DIRECT_CONNECT_KEY_INPUT_PORT_VALUE => new BoolParameter('Eingangsport Geschloßen'),
            IoService::ATTRIBUTE_DIRECT_CONNECT_KEY_OUTPUT_PORT => new IntParameter('Ausgangsport'),
            IoService::ATTRIBUTE_DIRECT_CONNECT_KEY_VALUE => new BoolParameter('Ausgangsport An'),
            IoService::ATTRIBUTE_DIRECT_CONNECT_KEY_PWM => new IntParameter('Ausgangsport PWM'),
            IoService::ATTRIBUTE_DIRECT_CONNECT_KEY_BLINK => new IntParameter('Ausgangsport Blinken'),
            IoService::ATTRIBUTE_DIRECT_CONNECT_KEY_FADE_IN => new IntParameter('Ausgangsport Einblenden'),
            IoService::ATTRIBUTE_DIRECT_CONNECT_KEY_ADD_OR_SUB => new IntParameter('Addieren oder subtrahieren'),
    ...
    public function getMethods(): array
    {
        return [
            'readPort' => (new Method('Port lesen'))
                ...
                ->setReturnTypes([
                    IoService::ATTRIBUTE_PORT_KEY_DIRECTION => $this->directionParameter,
                    IoService::ATTRIBUTE_PORT_KEY_VALUE => new IntParameter('Wert'),
                    IoService::ATTRIBUTE_PORT_KEY_DELAY => new IntParameter('Verzögerung'),
                    IoService::ATTRIBUTE_PORT_KEY_PULL_UP => new IntParameter('PullUp'),
                    IoService::ATTRIBUTE_PORT_KEY_PWM => new IntParameter('PWM'),
                    IoService::ATTRIBUTE_PORT_KEY_FADE_IN => new IntParameter('Fade In'),
                    IoService::ATTRIBUTE_PORT_KEY_BLINK => new IntParameter('Blinken'),
                ]),
            ...
            'setPort' => (new Method('Port setzen'))
                ->setParameters([
                    'slave' => $this->slaveParameter,
                    'number' => $this->portParameter,
                    IoService::ATTRIBUTE_PORT_KEY_NAME => new StringParameter('Name'),
                    IoService::ATTRIBUTE_PORT_KEY_DIRECTION => $this->directionParameter,
                    IoService::ATTRIBUTE_PORT_KEY_PULL_UP => new IntParameter('PullUp'),
                    IoService::ATTRIBUTE_PORT_KEY_DELAY => new IntParameter('Verzögerung'),
                    IoService::ATTRIBUTE_PORT_KEY_PWM => new IntParameter('PWM'),
                    IoService::ATTRIBUTE_PORT_KEY_BLINK => new IntParameter('Blinken'),
                    IoService::ATTRIBUTE_PORT_KEY_FADE_IN => new IntParameter('Fade In'),
                    IoService::ATTRIBUTE_PORT_KEY_VALUE => new IntParameter('Werte Namen'),
                ]),
            ...
            'saveDirectConnect' => (new Method('DirectConnect speichern'))
                ->setParameters([
                    ...
                    IoService::ATTRIBUTE_DIRECT_CONNECT_KEY_OUTPUT_PORT => new IntParameter('Ausgangsport'),
                    IoService::ATTRIBUTE_DIRECT_CONNECT_KEY_VALUE => new IntParameter('Ausgangsport An'),
                    IoService::ATTRIBUTE_DIRECT_CONNECT_KEY_PWM => new IntParameter('Ausgangsport PWM'),
                    IoService::ATTRIBUTE_DIRECT_CONNECT_KEY_BLINK => new IntParameter('Ausgangsport Blinken'),
                    IoService::ATTRIBUTE_DIRECT_CONNECT_KEY_FADE_IN => new IntParameter('Ausgangsport Einblenden'),
                    IoService::ATTRIBUTE_DIRECT_CONNECT_KEY_ADD_OR_SUB => new IntParameter('Addieren oder subtrahieren'),
